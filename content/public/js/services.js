...
var module = angular.module('AKSIServices', ['ngResource']);


module.factory('Productos', function($resource){
    var url = "/test/api/productos.php";
    return $resource(url, {},{
...
module.factory('Ubicaciones', function($resource){
    var url = "/test/api/ubicaciones.php";
    return $resource(url, {},{
        search:{method:"GET", params:{},isArray:true},
        create:{method:"POST", params:{} ,isArray:true}
    });
...
module.factory('Refacciones', function($resource){
    var url = "/test/api/refacciones.php";
    return $resource(url, {},{
        search:{method:"GET", params:{},isArray:true},
        create:{method:"POST", params:{} ,isArray:true}
    });
...
module.factory('Categories', function($resource){
    var url = apiBaseUrl+"/sites/MLM/categories";
